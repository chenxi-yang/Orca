...
class ModelEnv:
    ...
    Args:
        ...
        model (:class:`vrl.models.Model`): the model to wrap.
    ...
    def __init__(
        ...
        env: gym.Env,
        model: Model,
        termination_fn: vrl.util.types.TermFnType,
        reward_fn: Optional[vrl.util.types.RewardFnType] = None,
    ...
    def reset(
        ...
        """
        if isinstance(self.dynamics_model, vrl.models.OneDTransitionRewardModel):
    ...
    def step(
        self,
        actions: vrl.util.types.TensorType,
        model_state: Dict[str, torch.Tensor],
        sample: bool = False,
        symbolic: bool = False,
    ) -> Tuple[vrl.util.types.TensorType, vrl.util.types.TensorType, np.ndarray, Dict]:

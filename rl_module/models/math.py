...
class Normalizer:
    ...
    def update_stats(self, data: vrl.util.types.TensorType):
    ...
    def normalize(self, val: Union[float, vrl.util.types.TensorType]) -> torch.Tensor:
        ...
        elif isinstance(val, vrl.domain.box.Box): # val is the box
    ...
    def denormalize(self, val: Union[float, vrl.util.types.TensorType]) -> torch.Tensor:

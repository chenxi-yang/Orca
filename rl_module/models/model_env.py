...
from . import Model
from rl_module.models.one_dim_tr_model import OneDTransitionRewardModel
...
class ModelEnv:
    ...
    def __init__(
        ...
        # self.observation_space = env_obs_space
        # self.action_space = env_act_space
    ...
    def reset(
        ...
        """
        if isinstance(self.dynamics_model, OneDTransitionRewardModel):

...
def read_configs():
    ...
    parser.add_argument('--learner_epochs', type=int, default = 1000) # per actor # step, Orca's default is 1
...
def core():
    ...
    CKPT_DIR = f"./rl_module/training_log/safe_Orca"
    ...
    if is_learner:
        ...
        ckpt_path = f"{CKPT_DIR}/trained_model/learner/model.pth" # the policy
        ...
        while True:
            ...
            for steps_epoch in range(actor_epoch_length):
